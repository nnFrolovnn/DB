 ...
 *заполните ее данными из dbo.Person. ѕоле EmailAddress заполните данными из Person.EmailAddress;
*/
 ...
 *для которых тип контакта в таблице PhoneNumberType равен СWorkТ;
*/
delete p
from dbo.Person as p
